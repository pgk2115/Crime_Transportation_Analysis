...
setwd("C://Users//jessm//OneDrive//Documents//Columbia University//Fall 2019//STAT 5291 - Advanced Data Analysis//Project//Stops In Census Tract//Data//Baltimore")
...
chicagoCensusTract <- readOGR("BaltimoreBoundariesCensusTracts2010.geojson", layer = "BaltimoreBoundariesCensusTracts2010")
...
write.csv(chicagoCountOfStopsInCensusTract,"Baltimore_CountOfStopsInCensusTract.csv", row.names = FALSE)
