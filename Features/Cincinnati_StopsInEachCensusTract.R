...
setwd("C://Users//jessm//OneDrive//Documents//Columbia University//Fall 2019//STAT 5291 - Advanced Data Analysis//Project//Stops In Census Tract//Data//Cincinnati")
...
chicagoCensusTract <- readOGR("CincinnatiBoundariesCensusTracts2010.geojson", layer = "CincinnatiBoundariesCensusTracts2010")
...
write.csv(chicagoCountOfStopsInCensusTract,"Cincinnati_CountOfStopsInCensusTract.csv", row.names = FALSE)
